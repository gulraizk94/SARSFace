...
from face_process.bilinear_model import BilinearModel
from face_process.options import Options
from face_process.output_bs import OutputMeshBlendshapeKeyExp
from face_process.pix2pixHD.models import create_model
from face_process.texture_extractor import TextureExtractor
from face_process.utils import color_transfer, tensor2im, get_device, preserve_largest_area, filter_dpmap
...
class DetailProcessor:
    ...
    def gen_kep_exp_blendshape(self, this_output_path, save_dict):
        print("This is the output used for recons"+str(this_output_path))
