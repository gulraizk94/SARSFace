...
class BaseOptions():
    def initialize(self, parser):
        ...
        parser.add_argument('--preprocess', type=str, default='scale_width_and_crop',
        ...
        parser.add_argument('--preprocess_crop_padding', type=int, default=None,
                            help='padding parameter of transforms.RandomCrop(). It is not used if --preprocess does not contain crop option.')
        ...
        parser.add_argument("--netTExp")
        parser.add_argument("--netTAge")
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--continue_train', type=util.str2bool, default=False,
